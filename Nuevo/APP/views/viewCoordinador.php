...
<script type="text/javaScript">
    ...
    var dato = confirm("Seguro que desea actualizar el alumno ?"+ $IdCoordinador);
    if(!dato){
        window.location.href="../views/viewCoordinador.php";
    }else{
        window.location.href="../controllers/controladorCoordinadorr.php?IdCoordinaddor="+ $IdCoordinador + "&value=Actualizar"; 
    }
}
    function borrar($IdCoordinador) {
    var dato = confirm("Seguro que desea borrar al alumno "+ $IdCoordinador);
    if(!dato){
        window.location.href="../views/viewCoordinador.php";
    }else{
